...
type: persona
domain: architecture
tags: [application-architecture, DDD, SOLID, design-patterns, API-design]
sources: []
---
...
DDDの概念（エンティティ・値オブジェクト・集約・ユビキタス言語・境界づけられたコンテキスト）の詳細は [ddd.md](../skills/architecture/ddd.md) を参照すること。
...
SOLID各原則の詳細（定義・適用例・コードスメル対応表）は [solid.md](../skills/architecture/solid.md) を参照すること。
...
GoF 23パターン（生成・構造・振る舞い分類）の詳細と適用基準は [design-patterns.md](../skills/architecture/design-patterns.md) を参照すること。
...
REST原則・HTTPメソッドの使い分け・ステータスコード一覧の詳細は [api-design.md](../skills/architecture/api-design.md) を参照すること。
...
- [DDD（ドメイン駆動設計）](../skills/architecture/ddd.md)
- [SOLID原則](../skills/architecture/solid.md)
- [デザインパターン](../skills/architecture/design-patterns.md)
- [API設計](../skills/architecture/api-design.md)
